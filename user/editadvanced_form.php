 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class keyuser_user_editadvanced_form extends moodleform {

    /**
     * Define the form.
     */
    public function definition() {
        global $USER, $CFG, $COURSE, $KEYUSER_CFG;

        $CFG->defaultcity = $USER->city;
        ...
        $mform->setConstant('auth',$user->auth);
        */
        ...
        // Shared fields.
        keyuser_useredit_shared_definition($mform, $editoroptions, $filemanageroptions, $user);

        // Next the customisable profile fields.
        keyuser_profile_definition($mform, $userid, $KEYUSER_CFG->linked_fields);
