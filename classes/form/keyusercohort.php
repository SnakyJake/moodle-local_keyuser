 ...
 *
 * @package   keyuser_form
 * @copyright 2021 Jakob Heinemann, 2015 Damyon Wiese <damyon@moodle.com>
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class MoodleQuickForm_keyusercohort extends MoodleQuickForm_autocomplete {
    ...
    public function __construct($elementname = null, $elementlabel = null, $options = array()) {
        ...
        $validattributes = array(
            'ajax' => 'local_keyuser/form-keyusercohort-selector',
